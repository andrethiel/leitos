<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Postos/MasterPage.master" CodeFile="Pedido.aspx.cs" Inherits="UTI_Pedido" %>
        ...
        <div class="container">
            <div class="form-group row">
                <div class="col-sm-2" style="margin-top: 1%">
                    <asp:TextBox ID="TextBox2" CssClass="form-control ng-pristine ng-untouched ng-valid ng-empty" runat="server" AutoPostBack="true" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
                </div>
