...
public partial class Postos_imprimir : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        OracleDataAdapter da = new OracleDataAdapter("select * from paciente_internado_atual_v WHERE ds_setor_atendimento = '" + cookie_local.Value.ToString() + "'order by cd_unidade", cn);
        try
        {
            cn.Open();
