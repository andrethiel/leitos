<%@ Page Language="C#" AutoEventWireup="true" CodeFile="declaracao_paciente.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        ...
        <header>
            ...
            <article>
                <ul>
                    <li>
                        <div style="text-align: center; width: 100%; margin-top: 100px; font-size: 20px">DECLARAÇÃO</div>
                    </li>
                </ul>
            </article>
        </header>
        ...
        <main id="laudo" runat="server">
            <p class="pagebreak">
                Declaro para devidos fins que <span id="paciente" runat="server"></span>, 
                portadora do CPF: <span id="cpf_paciente" runat="server"></span> esteve no dia <span id="data" runat="server"></span>, no período das <span id="hora_inicio" runat="server"></span> ate às <span id="hora_final" runat="server"></span>, para a realização de exames nesta instituição hospitalar.
            </p>
