<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Acompanhante.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        ...
        <header>
            ...
            <article>
                <ul>
                    <li>
                        <div style="text-align: center; width: 100%; margin-top: 100px; font-size:20px">DECLARAÇÃO DE ACOMPANHAMENTO</div>
                    </li>
                </ul>
            </article>
        </header>

        <main id="laudo" runat="server">
            <p class="pagebreak">Declaro para devidos fins que <span id="acompanhante" runat="server"></span>, 
                portadora do CPF: <span id="cpf_acompanhante" runat="server"></span> esteve como acompanhante do paciente 
                <span id="paciente" runat="server"></span>, no dia <span id="data" runat="server"></span>, no período das <span id="hora_inicio" runat="server"></span> ate às <span id="hora_final" runat="server"></span>, o qual realizou exames  nesta instituição hospitalar.</p>
            <p style="margin-top: 100px;font-family: Arial;font-size: 18px;">Atenciosamente</p>
            <p style="margin-top: 100px;font-family: Arial;font-size: 18px;text-align:right" id="data_impressao" runat="server"></p>
        </main>
